...
namespace Lab_6
{
    internal class Program
    {
        static void Main()
        {
            ...
            {
                Console.WriteLine($"{student.Name} {student.Surname} {student.AvgMarks} {student.IsExpelled}");
            }
            Console.WriteLine();
            ...
            {
                new Green_4.Participant("Анастасия", "Сидорова"),
                ...
                new Green_4.Participant("Савелий", "Свиридов")
            };
            ...
            {
                new Green_5.Student("Татьяна", "Лисицына"), 
                new Green_5.Student("Анастасия", "Лисицына"), 
                new Green_5.Student("Виктор", "Полевой"),
                new Green_5.Student("Алевтина", "Батова"), 
                new Green_5.Student("Лев", "Жарков"), 
                new Green_5.Student("Лев", "Чехов"),
                new Green_5.Student("Юрий", "Зайцев"), 
                new Green_5.Student("Марк", "Петров"), 
                new Green_5.Student("Александра", "Чехова"),
            ...
            {
                new Green_5.Student("Оксана", "Зайцева"), 
                new Green_5.Student("Юрий", "Пономарев"), 
                new Green_5.Student("Юрий", "Тихонов"),
                new Green_5.Student("Степан", "Зайцев"), 
                new Green_5.Student("Марина", "Смирнова"), 
                new Green_5.Student("Светлана", "Кристиан"),
                new Green_5.Student("Алевтина", "Жаркова"), 
                new Green_5.Student("Инна", "Смирнова"), 
                new Green_5.Student("Алиса", "Сидорова"),
